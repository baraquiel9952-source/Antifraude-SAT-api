...
async function crearApiKey({ nombreCliente, plan = 'free', webhookUrl = null }) {
...
module.exports = { crearApiKey, obtenerApiKey, listarApiKeys, revocarApiKey, actualizarPlanApiKey, actualizarWebhookApiKey };
